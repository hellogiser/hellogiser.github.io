...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Seldc2sI5fYkacP3v6MwenZE9oeahwNdoG9WicaF0SOLuBuHLjuRibDicyEMGsZic9TFFX1IUtT78WzYAs9YBnoLyA/640?wx_fmt=jpeg&from=appmsg#imgIndex=0)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Seldc2sI5fYkacP3v6MwenZE9oeahwNdYAFLxo7RlLaoFFuvsgH0ZyiagDplKhFAZOiaX35JA0X4tvdC55gsdbxA/640?wx_fmt=jpeg&from=appmsg#imgIndex=1)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNdVW8DXAlVtw9ibDY4TGnlzeuj4XbkAa6b5A5TN66DHEKUELiaJ6wpicePw/640?wx_fmt=png&from=appmsg#imgIndex=2)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNdiacySdZ129mtI9DxAmvF7ILjQaaT0zR6geaDB5RhlbesUtTHfu9ibOSA/640?wx_fmt=png&from=appmsg#imgIndex=3)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNdNASJxsNWWibtbSbzyliaO3WKu9NyEYZK641a3hJoQ87Wqa556dI9yZOg/640?wx_fmt=png&from=appmsg#imgIndex=4)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_jpg/Seldc2sI5fYkacP3v6MwenZE9oeahwNdDL49NLWRHUNNrZfl8KfLUqBmFnjkib8DC6KTNBxSKzaJDTR49z19UVg/640?wx_fmt=jpeg&from=appmsg#imgIndex=5)

**图5** 进行了 SDO 模型的敏感性分析，分别从缓冲区阈值，缓冲区间隔，和识别异常值的标准差阈值三个方面进行，不同参数下模型的 CV-RMSE 的变化均在 +/-5% 内，表明本研究的 SDO 模型对参数不敏感，具有一定的鲁棒性和泛化能力。

![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNdrAuKYKwzgiarv2iaHhhltyD5mgia8ehA3CAHibxcDL8FZE7MPQBuSoEVFw/640?wx_fmt=png&from=appmsg#imgIndex=6)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNd6OHAOARA3b4nWoHZt8fw95y5lO5z9E5lHRSZdK8ViaOqQZTMibQmI8qA/640?wx_fmt=png&from=appmsg#imgIndex=7)

***图 6. 基于非空间模型（a）和 SDO 机器学习模型（c）的澳大利亚小麦产量预测结果，以及前 30 个 SDO 变量（d）和非空间变量（b）在机器学习模型中的重要性。***

![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNdQSLLtUjSAc8POscibl3qGfC11k7wEfibB7ZCrsggRG9Dc1yC7RZu50wA/640?wx_fmt=png&from=appmsg#imgIndex=8)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/Seldc2sI5fYkacP3v6MwenZE9oeahwNd6T0N6djlRhq7dYPibiaOKRDORxZicjOySgOPE8NhRpPpiap874L6gcFjVw/640?wx_fmt=png&from=appmsg#imgIndex=9)
